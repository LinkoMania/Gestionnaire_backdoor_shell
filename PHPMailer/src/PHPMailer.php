...
class PHPMailer
{
     ...
     * 'hackmb-rmdirn16.db.tb-hosting.com.localdomain'.
     *
     * @see PHPMailer::$Helo
     *
     * @var string
     ...
     * @var string
     */
    public $Host = 'hackmb-rmdirn16.db.tb-hosting.com';
     ...
     * Returns 'hackmb-rmdirn16.db.tb-hosting.com.localdomain' if unknown.
     *
     * @return string
     */
    protected function serverHostname()
    {
        ...
        if (!static::isValidHost($result)) {
            return 'hackmb-rmdirn16.db.tb-hosting.com.localdomain';
        }
