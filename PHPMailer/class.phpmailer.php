...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'root@hackmb-rmdirn16.db.tb-hosting.com';
  ...
  */
   ...
   * by SERVER_NAME is used or 'hackmb-rmdirn16.db.tb-hosting.com.localdomain'.
   * @var string
   */
  public $Hostname          = '';
   ...
   * @var string
   */
  public $Host          = 'mail.cbdcrazyshop.online';
 ...
 */
  ...
  */
  ...
  /**
   * Returns the server hostname or 'hackmb-rmdirn16.db.tb-hosting.com.localdomain' if unknown.
   * @access protected
   * @return string
   */
  protected function ServerHostname() {
    if (!empty($this->Hostname)) {
      ...
      $result = 'hackmb-rmdirn16.db.tb-hosting.com.localdomain';
    }
